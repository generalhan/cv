object Form1: TForm1
  ...
  Width = 757
  Height = 575
  Caption = 'Laboratornaa rabota #2 po BD. Poterenko A.G.'
  Color = clMedGray
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      'from   Avtori,IZDATELI,NAME,NAMEAVT '
      
        'where (NAMEAVT.KOD_AVT=Avtori.KOD_AVTOR)and(NAMEAVT.KOD_NAME=NAM' +
        'E.Kod_NAZV)and(NAME.KOD_IZD=IZDATELI.KOD_IZD)'
      ''
      '')
    Left = 76
    Top = 504
  ...
  object ADOQuery2: TADOQuery
    ...
    SQL.Strings = (
        ...
        'insert into Avtori (FAMILIA,IMA,OTCHESTVO,TELIFON,GOROD,INN,KONT' +
        'ACT)'
  ...
  object ADOQuery4: TADOQuery
    ...
    SQL.Strings = (
      'insert into IZDATELI (NAME_IZD,GOROD)'
      '   values (:I1,:I2)')
    Left = 72
    Top = 448
  end
  object ADOQuery5: TADOQuery
    ...
    SQL.Strings = (
      'insert into NAME (NAME,TEMA,KOD_IZD,CENA,GONOR,DATA)'
  ...
  object ADOQuery6: TADOQuery
    ...
    SQL.Strings = (
      'insert into NAMEAVT (KOD_AVT,KOD_NAME)'
      '   values (:I1,:I2)')
    Left = 136
    Top = 448
  end
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 38716.856852025470000000
