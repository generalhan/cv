//////////////////////////////////////////////////////////////////////////
//
//              Окончательная версия ЛР №5 по MFC
...
//////////////////////////////////////////////////////////////////////////
class CPaintDC_LAB5: public CPaintDC
{
    public:
	  //////////////////Конструктор///////////////////////////////////////
      CPaintDC_LAB5(CWnd* pWnd) : CPaintDC(pWnd)
	  {}
...
class CFrameWnd_LAB5 : public CFrameWnd
{
   private:
     bool flag;
   public:
	CMenu Menu_LAB5; //Меню для окна
    ///////////////////////////////Конструктор////////////////////////////
    CFrameWnd_LAB5()
	{
        flag=false;
		...
		Menu_LAB5.LoadMenu(IDR_MENU1);
        SetMenu(&Menu_LAB5);
	};
	//////////////////////////////////////////////////////////////////////
    void LAB5_MENU_FUNC1()
	{
		flag=true;       
	...
	//////////////////////////////////////////////////////////////////////
    void LAB5_MENU_FUNC2()
	{
	    CDialog_LAB5 D;
	    D.DoModal();	
	};
    //////////////////////////////////////////////////////////////////////
	void LAB5_MENU_FUNC3()
	{
	  	DestroyWindow();
	};
	//////////////////////////////////////////////////////////////////////
...
/////////////////////////////Карта сообщений//////////////////////////////
//////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CFrameWnd_LAB5, CFrameWnd)
    ON_WM_PAINT()
	ON_COMMAND(ID_MENUITEM40001,LAB5_MENU_FUNC2)
	ON_COMMAND(ID_MENUITEM40002,LAB5_MENU_FUNC1)
    ON_COMMAND(ID_MENUITEM40003,LAB5_MENU_FUNC3)
    ON_WM_VSCROLL()
	ON_WM_HSCROLL()
	ON_WM_CREATE()
	ON_WM_SIZE()
...
//////////////////////////////////////////////////////////////////////////
class CWinApp_LAB5 : public CWinApp
{
  public:
    //////////////////////////////////////////////////////////////////////
	CWinApp_LAB5()
...
///////////////////////////////////////////////////////////////////////////
CWinApp_LAB5 theApp; //Создаем глобальный объект приложения	
